...
class PromptGUI(object):
    ...
    def init_sam_model(self):
        if self.sam_model is None:
            self.sam_model = build_sam2_video_predictor(self.model_cfg, self.checkpoint_path)
            guru.info(f"loaded model checkpoint {self.checkpoint_path}")
...
def make_demo(
    ...
    prompts = PromptGUI(checkpoint_path, model_cfg)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default="./checkpoints/sam2.1_hiera_large.pt")
